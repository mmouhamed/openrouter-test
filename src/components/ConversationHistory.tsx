...
export default function ConversationHistory({ isOpen, onClose }: ConversationHistoryProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 right-0 h-full w-80 bg-white/70 dark:bg-gray-900/80 backdrop-blur-md border-l border-white/20 dark:border-gray-700/50 shadow-xl z-40 transform transition-transform duration-300 ease-in-out ${
